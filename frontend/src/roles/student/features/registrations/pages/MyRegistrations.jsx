...
import { getMyRegistrations } from '../../../../../features/registrations/registration.service';
            ...
            <Card className="h-full flex flex-col gap-4">
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-slate-800 dark:text-white text-base leading-tight">{reg.eventId?.name || reg.event}</h3>
                  <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                    <Badge variant={categoryColors[reg.eventId?.category || reg.category] || 'secondary'}>{reg.eventId?.category || reg.category}</Badge>
